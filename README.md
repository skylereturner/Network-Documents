...
Physical network topology is attached to the repository titled assignment 5 topology.pdf
# Logical network topology:  
Logical network topology is attached to the repository titled assignment 5 topology.pdf
...
The router is completely configured and managed by ISP So, there is no relevant device configuration information that I know of because I do not have access to the routers management page
...
Fixed grammar mistakes 7/28/2026  
No other changes have been made to the document  
# References to any related files or diagrams
Network topology has been attached to the repository with the title of assignment 5 topology.pdf
